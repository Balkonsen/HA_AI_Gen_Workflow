...
**Plans**: 1/4 plans executed (planned 2026-08-29)
...
- [ ] 02-01: ruamel round-trip loader with HA custom-tag constructors/representers
- [ ] 02-02: Include-graph builder
- [ ] 02-03: Touched-file-only write layer + byte-identical dump tests
- [ ] 02-04: Idempotency harness
...
|-------|----------------|--------|-----------|
| 1. Connect & Discover | 1/4 | In Progress|  |
