...
from ssh_transfer import SSHTransfer, HARemoteManager  # noqa: E402
...
class TestSSHTransfer:
    ...
    def test_authentication_failure(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=255, stdout="", stderr="Permission denied (publickey,password)")
    ...
    def test_download_file_permission_denied(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=1, stdout="", stderr="scp: /remote/test.txt: Permission denied")
    ...
    def test_custom_timeout_values(self, mock_mkdir, mock_run):
        ...
        ssh = SSHTransfer(host="test.host.com", connection_timeout=45, transfer_timeout=900)
...
class TestTimeoutConfiguration:
    ...
    def test_timeout_from_config(self, mock_mkdir, mock_run):
        ...
        ssh = SSHTransfer(host="test.host.com", connection_timeout=50, transfer_timeout=1000)
...
class TestUnicodeHandling:
    ...
    def test_unicode_in_error_message(self, mock_run):
        ...
        # Simulate error message with Unicode ellipsis character (â€¦)
        unicode_error = "Connection failedâ€¦ authentication required"
        mock_run.return_value = Mock(returncode=1, stdout="", stderr=unicode_error)
    ...
    def test_unicode_in_stdout(self, mock_run):
        ...
        unicode_output = "âœ“ Success: Connectedâ€¦ status: ready â†’ configured âš  Warning"
        mock_run.return_value = Mock(returncode=0, stdout=unicode_output, stderr="")
    ...
    def test_mixed_unicode_ascii_content(self, mock_run):
        ...
        mixed_content = "ASCII text with emoji ðŸ” and symbols: â‚¬Â£Â¥ â†’ â† â†‘ â†“"
        mock_run.return_value = Mock(returncode=0, stdout=mixed_content, stderr="")
