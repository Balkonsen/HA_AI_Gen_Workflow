...
from ha_ai_context_gen import HAContextGenerator, HAYAMLLoader  # noqa: E402


def _yaml_text(data) -> str:
...
""")
        ...
        homeassistant = result["homeassistant"]
        assert isinstance(homeassistant, dict)
        assert homeassistant["name"] == "Test Home"
        # !secret tags should be preserved as strings
        assert "!secret latitude" in str(homeassistant["latitude"])
...
"""
    ...
    def test_analyze_configuration_missing_file(self, temp_dir):
        ...
        assert (
            generator.context["system_overview"] == {}
            or "configured_platforms" not in generator.context["system_overview"]
        )
...
class TestAnalyzeDevices:
    ...
    def test_analyze_devices_with_data(self, temp_dir):
        ...
        devices_data = {
            "total_devices": 3,
            "devices_by_manufacturer": {"Philips": 2, "IKEA": 1},
            "devices_by_integration": {"hue": 2, "tradfri": 1},
        }
...
class TestAnalyzeAutomations:
    ...
    def test_analyze_automations_with_data(self, temp_dir):
        ...
        (config_dir / "automations.yaml").write_text(_yaml_text(automations))
...
class TestAnalyzeScripts:
    ...
    def test_analyze_scripts_with_data(self, temp_dir):
        ...
        (config_dir / "scripts.yaml").write_text(_yaml_text(scripts))
...
class TestGenerateAIPrompt:
    ...
    def test_generate_ai_prompt(self, temp_dir):
        ...
        generator.context = {
            ...
            "automations": {
                "total": 2,
                "list": [{"alias": "Test", "triggers": 1, "actions": 1}],
            },
            "scripts": {"total": 1},
            "addons": {
                "total": 2,
