...
class SSHTransfer:
    ...
    def __init__(self, host: str, user: str = "root", port: int = 22,
                 ...
                 connection_timeout: int = 30, transfer_timeout: int = 600,
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    if "Connection refused" in error_msg:
                        ...
                        return False, f"Authentication failed: Check username, password, or SSH key"
    ...
    def download_file(self, remote_path: str, local_path: str) -> bool:
        ...
        for attempt in range(self.retry_attempts):
            try:
                ...
                print(f"✗ Download error: SCP command not found")
                return False
        ...
        for attempt in range(self.retry_attempts):
            try:
                ...
                if "scp" in str(e).lower():
                    logger.error(f"SCP command not found: {e}")
                    print(f"✗ Upload error: SCP command not found")
                else:
    ...
    def _rsync_download(self, remote_path: str, local_path: str,
        ...
        try:
            ...
            print(f"✗ rsync error: rsync command not found")
            return False
